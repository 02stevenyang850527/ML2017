...
un_num = 2000
un_feature = train_feature[:un_num]
train_feature = train_feature[un_num:]
train_label = train_label[un_num:]
...
un_feature = un_feature.reshape(un_feature.shape[0],48,48,1)
...
csv_logger0 = CSVLogger('training0.csv')
